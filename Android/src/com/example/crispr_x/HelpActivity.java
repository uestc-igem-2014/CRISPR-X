...
public class HelpActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lvMenu.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (arg2) {
				case 0:
					intent = new Intent(HelpActivity.this, SubmitActivity.class); // 启动Activity
					startActivity(intent);
					finish();
					break;
				case 1:
				...
				case 2:
					if (isLogin) {
						intent = new Intent(HelpActivity.this,
					...
					break;
				case 3:
					intent = new Intent(HelpActivity.this, WebActivity.class); // 启动Activity
					startActivity(intent);
					finish();
					break;
				case 4:
	...
	protected void contactDialog() {
		...
		AlertDialog.Builder builder = new Builder(HelpActivity.this);
		builder.setView(DialogView);

		Button btnMail = (Button) DialogView.findViewById(R.id.button_mail);

		btnMail.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(Intent.ACTION_SEND);
				// 收件人  
				intent.putExtra(android.content.Intent.EXTRA_EMAIL,new String[] {"devinzhang91@gmail.com"});  
		        // 主题  
		        intent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Crispr-X");  
		        // 正文  
		        intent.putExtra(android.content.Intent.EXTRA_TEXT," APP Name : Crispr-X \n");
		        startActivity(Intent.createChooser(intent, "Mail Chooser"));
			}
		});

		btnMail.setOnTouchListener(new Button.OnTouchListener() {
			@Override
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					v.setBackgroundResource(R.drawable.deep);
